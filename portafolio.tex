...
\chapter{Projects}  % cuerpo del portafolio
\subfile{tex/numerical-differentiation}
\subfile{tex/git-version-control}
\subfile{tex/numerical-integration}
\subfile{tex/root-finding-methods}
\subfile{tex/ordinary-differential-equations}
\subfile{tex/runge-kutta-methods}
\subfile{tex/curve-fitting}
\subfile{tex/interpolation-methods}
\subfile{tex/stochastic-simulations}
